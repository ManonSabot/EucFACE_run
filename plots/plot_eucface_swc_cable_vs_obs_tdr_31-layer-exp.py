...
# _________________________ CABLE ___________________________
    ...
    swilt[:] = ( cable.variables['swilt'][0]*0.020440 \
                ...
                + cable.variables['swilt'][6]*0.021546 \
                + cable.variables['swilt'][7]*0.028141 \
                + cable.variables['swilt'][8]*0.035616 \
                + cable.variables['swilt'][9]*0.043971 \
                + cable.variables['swilt'][10]*0.053205 \
                + cable.variables['swilt'][11]*0.063318 \
                + cable.variables['swilt'][12]*0.074311 \
                + cable.variables['swilt'][13]*0.086183 \
    ...
    sfc[:] =   ( cable.variables['sfc'][0]*0.020440 \
                ...
                + cable.variables['sfc'][6]*0.021546 \
                + cable.variables['sfc'][7]*0.028141 \
                + cable.variables['sfc'][8]*0.035616 \
                + cable.variables['sfc'][9]*0.043971 \
                + cable.variables['sfc'][10]*0.053205 \
                + cable.variables['sfc'][11]*0.063318 \
                + cable.variables['sfc'][12]*0.074311 \
                + cable.variables['sfc'][13]*0.086183 \
    ...
    ssat[:] =  ( cable.variables['ssat'][0]*0.020440 \
                ...
                + cable.variables['ssat'][6]*0.021546 \
                + cable.variables['ssat'][7]*0.028141 \
                + cable.variables['ssat'][8]*0.035616 \
                + cable.variables['ssat'][9]*0.043971 \
                + cable.variables['ssat'][10]*0.053205 \
                + cable.variables['ssat'][11]*0.063318 \
                + cable.variables['ssat'][12]*0.074311 \
                + cable.variables['ssat'][13]*0.086183 \
...
# ____________________ Plot obs _______________________
    ...
    fig.savefig("EucFACE_Prcp-SW_tdr_GW_Or_Hvrd_31l_amb_%s.png" % (case_name), bbox_inches='tight', pad_inches=0.1)
