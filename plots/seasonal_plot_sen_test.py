...
def main(ctl_fname, amb_fname, case_name):
    ...
    plot_fname = "seasonal_plot_gw_on_or_on_hyds_test_31layers_%s.png" % (case_name)
    plot_dir = "plots"
...
if __name__ == "__main__":
    ...
    #case = ["bch1.5","cnsd2","css1.5","hyds10","sfc2","ssat2","sucs2","swilt2"]
    case = ["hyds0.01", "hyds0.1", "hyds10", "hyds100"]
    for case_name in case:
        ctl_fname = "/g/data/w35/mm3972/cable/EucFACE/EucFACE_run/outputs/hyds_test/31layer_hyds_test/hyds/EucFACE_amb_out.nc"
        amb_fname = "/g/data/w35/mm3972/cable/EucFACE/EucFACE_run/outputs/hyds_test/31layer_hyds_test/%s/EucFACE_amb_out.nc" % (case_name)
        
        main(ctl_fname, amb_fname, case_name)
