...
# ____________________ Plot obs _______________________
    ...
    ax10.set_xlim([0,2372])
    ax10.set_ylim([0.0,0.4])
    ax11.set_xlim([0,2372])
    ax11.set_ylim([0.0,0.4])
    ax12.set_xlim([0,2372])
    ...
    fig.savefig("EucFACE_Prcp-SW_neo_GW_Or_Hvrd_Nzdpt_13l_amb_%s.png" % (case_name), bbox_inches='tight', pad_inches=0.1)
