...
if __name__ == "__main__":
    ...
    if dim_info == "3d":
        var_names  = ["bch","hyds"]
        case_name  = "fix_hie_exp" #"EucFACE_run_sen_31uni_2bch-mid-bot"
        ...
        for k in np.arange(5):
            ...
            for i in np.arange(len(var_values1)):
                for j in np.arange(len(var_values2)):
                    ...
                    output_file = "/srv/ccrc/data25/z5218916/cable/EucFACE/EucFACE_run_sen_31uni_bch-hyds-top1/%s/outputs/met_LAI_vrt_swilt-watr-ssat_SM_31uni_bch=%s-hyds^%s_fw-hie-exp_fix/EucFACE_amb_out.nc"\
                                   % (case_name, var_values1[i], var_values2[j])
