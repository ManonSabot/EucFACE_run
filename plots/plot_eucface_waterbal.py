...
def main(case_name, layers, zse):

    file_path = "/srv/ccrc/data25/z5218916/cable/EucFACE/EucFACE_run/outputs/%s/" % (case_name)
    ...
    # output
    df_amb.to_csv("EucFACE_amb_%s.csv" %(case_name))
    df_ele.to_csv("EucFACE_ele_%s.csv" %(case_name))
