...
file_path = "/g/data1a/w35/mm3972/cable/EucFACE/EucFACE_run/outputs/calculated_para_gridinfo_ununi_gw_on/after_changing_cable_input_as_abs_sucs_vec_1000/depth_varied_para_gw_on_or_on/"
...
# output
df_amb.to_csv("EucFACE_amb_gw_on_or_on.csv")
df_ele.to_csv("EucFACE_ele_gw_on_or_on.csv")
