...
__author_version__  = "1.0 (04.08.2018)"
...
def main(met_fname, lai_fname, obs_fname, out_fname, co2_conc):
...
# why this def is here??? MMY
def estimate_rhosoil_vec(obs_fname):
    """
    Using obs VWC & Bulk.den to calculate Soil density
    """
    neo = pd.read_csv(obs_fname, usecols = ['Ring','Depth','Date','VWC','Bulk.den','GWC'])
...
if __name__ == "__main__":
    ...
    obs_fname = "/short/w35/mm3972/data/Eucface_data/swc_at_depth/FACE_P0018_RA_NEUTRON_20120430-20190510_L1.csv"
    for co2_conc in ["amb", "ele"]:
        out_fname = "EucFACE_met_%s.nc" % (co2_conc)
        main(met_fname, lai_fname, obs_fname, out_fname, co2_conc=co2_conc)
