...
class RunCable(object):
    ...
    def worker(self, met_files, url, rev):
        ...
        nml_fname = "cable_%s_%s_%s.nml" % (site, self.met_fname, self.case_name)
        shutil.copy(base_nml_fn, nml_fname)

        (out_fname, out_log_fname, out_restart_fname) = self.clean_up_old_files(site, ring)
    ...
    def initialise_stuff(self):
        ...
        if len(self.met_subset) == 0:
            ...
            met_files = os.path.join(self.met_dir, self.met_subset)
